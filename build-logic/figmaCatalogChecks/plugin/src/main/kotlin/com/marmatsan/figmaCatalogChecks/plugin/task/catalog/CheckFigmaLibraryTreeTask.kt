...
abstract class CheckFigmaLibraryTreeTask : DefaultTask() {
    @get:Input
    ...
    fun checkLibraryTree() {
        ...
        val result = FigmaCatalogChecksComponent::class.create().catalogTreeChecker.checkLibraryTree(
        ...
        logger.lifecycle(
            "Figma section '${result.sectionNodeId}' matches ${result.repositoryNodeCount} repository library nodes."
        )
    }
}
