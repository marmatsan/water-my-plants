...
abstract class CheckFigmaBuildLogicLibraryTreeTask : DefaultTask() {
    @get:Input
    ...
    fun checkLibraryTree() {
        ...
        val result = FigmaCatalogChecksComponent::class.create().catalogTreeChecker.checkBuildLogicLibraryTree(
        ...
        logger.lifecycle(
            "Figma section 'Build Logic library catalog trees' matches " +
                "${result.repositoryNodeCount} build-logic library nodes."
        )
    }
}
