...
from `figmaDesignSync-domain`. It is allowed to read files, parse Gradle Kotlin
...
# Package com.marmatsan.figmaDesignSync.data.datasource
...
# Package com.marmatsan.figmaDesignSync.data.figma
