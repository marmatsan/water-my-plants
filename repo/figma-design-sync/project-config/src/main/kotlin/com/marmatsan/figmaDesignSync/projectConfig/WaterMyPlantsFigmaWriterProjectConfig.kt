...
import com.marmatsan.figmaDesignSync.domain.model.writer.FigmaCatalogTreeTargetLifecycle
import com.marmatsan.figmaDesignSync.domain.model.writer.FigmaCatalogTreeTargetType
import com.marmatsan.figmaDesignSync.domain.model.writer.FigmaHeaderSectionTarget
import com.marmatsan.figmaDesignSync.domain.model.writer.FigmaProjectLink
...
internal object WaterMyPlantsFigmaWriterProjectConfig {
    ...
    val value = FigmaWriterProjectConfig(
        ...
        headerSectionTargets = listOf(
            ...
            FigmaHeaderSectionTarget(
                ...
                links = links(
                    "repo/figma-design-sync/plugin/src/main/kotlin/com/marmatsan/figmaDesignSync/" +
                        "plugin/gradle/FigmaDesignSyncGradlePlugin.kt"
                )
            )
        ),
        versionSectionTargets = mapOf(
            "Main project dependencies" to FigmaVersionSectionTarget(
                parentNodeId = "64247:3827",
                variableFolder = "Main project dependencies"
            ),
            "Libraries" to FigmaVersionSectionTarget(
                parentNodeId = "64247:3853",
                variableFolder = "Libraries"
            ),
            "Plugins" to FigmaVersionSectionTarget(
        ...
        usageChipProps = mapOf(
            "kind" to "kind",
            "name" to "name"
        ),
        usageChipKinds = mapOf(
            "module" to "module",
            "conventionPlugin" to "convention-plugin"
        ),
        catalogTreeTargets = listOf(
            catalogTarget(
