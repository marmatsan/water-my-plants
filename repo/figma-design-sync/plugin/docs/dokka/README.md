...
the same model hash. It is the only `figmaDesignSync` module that should know
about Gradle tasks.

Read this module by workflow:

1. `FigmaDesignSyncGradlePlugin` registers the public Gradle tasks.
...
# Package com.marmatsan.figmaDesignSync.plugin.task
...
# Package com.marmatsan.figmaDesignSync.plugin.checker
