...
const projectConfigJson = process.env.FIGMA_DESIGN_SYNC_PROJECT_CONFIG;
if (!projectConfigJson) {
  throw new Error(
    "FIGMA_DESIGN_SYNC_PROJECT_CONFIG must point to the Kotlin-generated writer project config."
  );
}
