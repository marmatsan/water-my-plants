...
class CiPlanFactoryTest : FunSpec(
    ...
    companion object {
        ...
        private fun com.marmatsan.verificationPlatform.domain.model.CiPlan.requiredUnitIds() =
            verificationUnits.filter { it.required }.map { it.id }

        private fun com.marmatsan.verificationPlatform.domain.model.CiPlan.gradleTasks() =
            requiredGradleTasks()
    }
}
