---
title: Figma Documentation Sync distribution contract
type: reference
...
sources:
  ...
  - repo/figma-documentation-sync/tools/fixtures/contracts/writer-runtime-contract.json
  - repo/figma-documentation-sync/samples/standalone-consumer
---

# Figma Documentation Sync Distribution Contract

## Purpose

This reference defines the artifacts, versions, public entry points, and
release gates used to consume Figma Documentation Sync without source modules or an
included build.
...
```text
@marmatsan/figma-documentation-sync-tools
```
...
`repo/figma-documentation-sync/gradle.properties` owns the staged Maven version.
