...
- `../../plugin/src/test/resources/com/marmatsan/figmaDocumentationSync/plugin/bdd/figma-design-model.feature`
- `../../plugin/src/test/kotlin/com/marmatsan/figmaDocumentationSync/plugin/bdd/RunCucumberTest.kt`

## Running Cucumber

Run all `figmaDocumentationSync` plugin tests:
...
```powershell
.\gradlew.bat :figma-documentation-sync:plugin:test -Dcucumber.filter.tags="@figma-design-model"
```
...
- `../../plugin/src/test/kotlin/com/marmatsan/figmaDocumentationSync/plugin/bdd/DesignModelSteps.kt`
- `../../plugin/src/test/kotlin/com/marmatsan/figmaDocumentationSync/plugin/bdd/GradleTaskSteps.kt`
- `../../plugin/src/test/kotlin/com/marmatsan/figmaDocumentationSync/plugin/bdd/CucumberTypes.kt`
...
[2]: ../../plugin/src/test/kotlin/com/marmatsan/figmaDocumentationSync/plugin/bdd
