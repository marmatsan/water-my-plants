...
sources:
  - repo/figma-documentation-sync/tools/src/app/sync-catalog-tree-preview.mcp.ts
  - repo/figma-documentation-sync/tools/scripts/write-mcp-preview.ts
  - repo/figma-documentation-sync/plugin/src/main/kotlin/com/marmatsan/figmaDocumentationSync/plugin/task/visual/GenerateCiVisualPlanTask.kt
---
...
```text
repo/figma-documentation-sync/tools/fixtures/visual/
```
...
```text
repo/figma-documentation-sync/tools/dist/mcp-runners/
```
