...
sources:
  ...
  - repo/figma-documentation-sync/project-config/src/main/kotlin/com/marmatsan/figmaDocumentationSync/projectConfig/TeamCityOfficialFigmaPayloadUploader.kt
  ...
  - repo/figma-documentation-sync/plugin/src/main/kotlin/com/marmatsan/figmaDocumentationSync/plugin/task/artifact/ValidateOfficialFigmaArtifactSetTask.kt
---
...
Figma Sync pipeline to set `FIGMA_DOCUMENTATION_SYNC_OFFICIAL=true` and
...
- `.teamcity/settings.kts`
- `plugin/src/main/kotlin/com/marmatsan/figmaDocumentationSync/plugin/task/official/PrepareOfficialFigmaSyncTask.kt`
...
- `project-config/src/main/kotlin/com/marmatsan/figmaDocumentationSync/projectConfig/TeamCityOfficialFigmaPayloadUploader.kt`
