            ...
            jobs = listOf(
                job(
                    ...
                    dependencies = listOf(
                        CiJob.Dependency(
                            "generate",
                            listOf("build/reports/figma-sync")
                        )
                    )
                ),
                job(
                    ...
                    steps = listOf(
                        CiJob.Step(
                            "RUNNER_1",
                            "Generate config",
                            ".\\mvnw.cmd teamcity-configs:generate"
                        ),
                        CiJob.Step(
                            "RUNNER_2",
                            "Generate model",
