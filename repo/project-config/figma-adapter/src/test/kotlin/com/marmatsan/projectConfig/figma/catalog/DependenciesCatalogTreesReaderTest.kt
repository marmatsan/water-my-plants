...
private fun dependenciesCatalogTreesReader(): DependenciesCatalogTreesReader =
    DependenciesCatalogTreesReader(
        dependencyCatalog = testDependencyCatalog(),
...
private fun testDependencyCatalog(): DependencyCatalog =
    DependencyCatalog(
        libraries =
            listOf(
                SourceLibraryCatalogNode(
                                ...
                                entries =
                                    listOf(
                                        SourceLibraryCatalogEntry.Artifact(
                                            ...
                                            version = "activityComposeLibraryVersion"
                                        )
                                    )
                            ),
                            SourceLibraryCatalogNode(
                                ...
                                entries =
                                    listOf(
                                        SourceLibraryCatalogEntry.Artifact(
                                            name = "compose-bom",
                                            version = "composeBomLibraryVersion"
                                        )
                                    ),
                                children =
                                    listOf(
                                            ...
                                            entries =
                                                listOf(
                                                    SourceLibraryCatalogEntry.Artifact(
                                                        ...
                                                        version = "protobufLibraryVersion"
                                                    ),
                                                    SourceLibraryCatalogEntry.Artifact(
                                                        name = "protoc",
                                                        version = "protobufLibraryVersion"
                            ...
                            SourcePluginCatalogNode(
                                ...
                                children =
                                    listOf(
                                        SourcePluginCatalogNode(
                                            id = "application",
                                            version = "androidGradlePluginVersion"
                                        ),
                                        SourcePluginCatalogNode(
                                            id = "library",
                                            version = "androidGradlePluginVersion"
