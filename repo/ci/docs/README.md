# Repository CI Planner Documentation

## Purpose

This directory is the documentation entry point for the provider-neutral CI
planner under `repo/ci`. It connects the executable behavior, generated Kotlin
API reference, shared engineering standards, and the module's implementation
overview without duplicating their contracts.
...
| `plugin` | `data`, `domain` | Gradle tasks and composition of the planner. |
