...
fun PlantScreenForm(
    ...
    Surface(
        ...
        val descriptionTextFieldInteractionSource = remember { MutableInteractionSource() }

        val isDescriptionTextFieldFocused by descriptionTextFieldInteractionSource.collectIsFocusedAsState()
            ...
            Row(
                ...
                Column(
                    ...
                    CustomTextField(
                        ...
                        interactionSource = descriptionTextFieldInteractionSource
                    )
                }
