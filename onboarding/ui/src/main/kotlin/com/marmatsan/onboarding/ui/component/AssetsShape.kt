...
fun AssetsShape(
    ...
    val (resId, width, height) = when (variant) {
        AssetsShapeVariant.Shape1 -> Triple(
            R.drawable.assets_shape_shape1,
            95.154.dp,
            69.31.dp
        )
        AssetsShapeVariant.Shape2 -> Triple(
            R.drawable.assets_shape_shape2,
            89.dp,
            42.dp
        )
        AssetsShapeVariant.Shape3 -> Triple(
...
private class AssetsShapePreviewParameterProvider :
    PreviewParameterProvider<AssetsShapeVariant> {
